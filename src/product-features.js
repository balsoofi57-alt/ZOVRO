...
implementation:{growthWorkflows:'implemented-and-tested',scaleWorkflows:'implemented-and-tested',externalLaunchGates:'pending-credentials-signing-and-live-evidence'}
};
const LAUNCH_PHASES=[
...
{id:'scale',name:'Scale & Operations',priorities:['Admin Command Center','Provider teams','Performance scoring','Dispute Center','Fraud protection','Guarantee framework','Referral rewards','Provider subscriptions','Tax and earnings statements','Multi-stop jobs','Warranty records','Accessibility and translation helpers']}
];
