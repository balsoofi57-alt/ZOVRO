...
const required=['index.html','www/index.html','manifest.webmanifest','www/manifest.webmanifest','capacitor.config.json','backend/server.js','backend/server-core.js','backend/database.js','backend/payments.js','privacy.html','terms.html','support.html'];
...
const html=fs.readFileSync(path.join(root,'www/index.html'),'utf8');if(!html.includes('ZOVRO_CONFIG')||!html.includes('i18n.js')){console.error('Mobile runtime configuration or localization missing');bad=true}
