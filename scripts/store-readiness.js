...
const pushClient=fs.readFileSync(path.join(root,'push-client.js'),'utf8'),prepare=fs.readFileSync(path.join(root,'scripts/prepare-mobile.js'),'utf8'),paymentUi=fs.readFileSync(path.join(root,'payment-ui.js'),'utf8');
