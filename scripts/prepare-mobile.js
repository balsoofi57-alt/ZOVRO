...
for(const name of ['manifest.webmanifest','service-worker.js','privacy.html','terms.html','support.html','biometric-client.js','secure-session.js','i18n.js','consent-client.js','payment-client.js','push-client.js','payment-ui.js','live-map.js','support-center.js'])fs.copyFileSync(path.join(root,name),path.join(out,name));
...
console.log('Prepared ZOVRO mobile bundle',JSON.stringify({api,version:pkg.version,channel,oneSignalAppId,webDir:'www',secureSession:true,biometricUnlock:true,legalConsent:true,liveMaps:true,supportCenter:true,mapLibrary:'leaflet-local',mapTileUrl}));
