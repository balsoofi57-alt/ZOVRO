...
const required=['schemaVersion 7','workflow_records','BEGIN','ROLLBACK','postgres_write_probe_pass','postgres_write_probe_failed'];
let bad=false;
...
console.log(JSON.stringify({ok:true,postgresProbeGuard:true,rollbackRequired:true,schemaVersion:7}));
