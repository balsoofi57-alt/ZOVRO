...
const keyMap={sms_receipts:'smsReceipts',users:'users',service_requests:'requests',messages:'messages',ratings:'ratings',audit_log:'audit',workflow_records:'workflows',verification_requests:'verificationRequests',provider_locations:'providerLocations',device_sessions:'deviceSessions',notifications:'notifications'};
