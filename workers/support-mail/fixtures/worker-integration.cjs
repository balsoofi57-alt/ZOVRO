...
Module._load=function(name,parent,isMain){
 ...
 if(name==='mailparser')return {simpleParser:async()=>({from:{value:[{address:TEST_RECIPIENT}]},to:{value:[{address:SUPPORT}]},headers:new Map(),text:'What is ZOVRO?',messageId:'<worker-integration@example.test>',attachments:[]})};
